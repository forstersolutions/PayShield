...
requireText("services/core/product.mjs", "buildCommercialOperatingState");
requireText("services/core/product.mjs", "buildGuidedMoneyFlow");
requireText("services/core/product.mjs", "buildActivationRunway");
requireText("services/core/product.mjs", "payshield-operating-cockpit");
requireText("services/core/product.mjs", "payshield-commercial-operating-state");
requireText("services/core/product.mjs", "payshield-guided-money-flow");
requireText("services/core/product.mjs", "payshield-activation-runway");
requireText("services/core/product.mjs", "operatingCockpit");
requireText("services/core/product.mjs", "commercialOperatingState");
requireText("services/core/product.mjs", "guidedMoneyFlow");
requireText("services/core/product.mjs", "activationRunway");
